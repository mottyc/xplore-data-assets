...
public class StringUtils {
	 ...
	 * @return List of string
	 */
	public static List<Integer> splitInt(String list) {
		List<Integer> result = new ArrayList<>();
		List<String> strings = split(list, ",");
	...
	/**
	 * Check if string value is in the list
	 * @param value String value
	 * @param list Comma-separated list of valid values
	 * @return
	 */
	...
	/**
	 * Get tokenized list of the exception stack
	 * @param ex
	 * @return
	 */
	public static String getExceptionStak(Exception ex) {
		StackTraceElement[] stack = ex.getStackTrace();
		
		String errorList = ex.toString();
		if (stack != null) {
			for (StackTraceElement elem : stack) {
				errorList = String.format("%s | %s", errorList, elem.toString());
			}
		}
		return errorList;
	}
	...
	/**
	 * Convert JSON string to a specified type
