...
angular.module('myApp')
    ...
    .directive('selectTablesModal', function () {
        'use strict';
        return {
            restrict: 'A',
            scope: {
            ...
            templateUrl: 'views/directives/selection/select-tables.html',
            transclude: true,
            controller: ['$scope', '$modal', '$transclude', function ($scope, $modal, $transclude) {
                ...
                $scope.openModal = function () {
                    $modal.open({
                        controller: 'selectTablesController',
                        controllerAs: 'ctrl',
                        resolve: {
                            content: function () {
                        ...
                        scope: $scope,
                        templateUrl: "select-tables-template.html"
                    })
                        .result.then(
                        function () {
                            $scope.close(); // closed
