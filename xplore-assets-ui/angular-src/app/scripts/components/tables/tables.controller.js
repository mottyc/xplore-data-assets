...
(function () {
    ...
    tablesController.$inject = ["$scope", "pfViewUtils", "tablesManager"];

    function tablesController($scope, pfViewUtils, tablesManager) {
        ...
        self.loadEntities = function(page) {
            ...
            tablesManager.getAll(page).then(function (result) {
