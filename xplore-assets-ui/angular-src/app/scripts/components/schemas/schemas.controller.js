    ...
    function schemasController(pfViewUtils, schemasManager, MdaSchemaModel, Notifications) {
        ...
        self.loadEntities = function () {
            ...
            if (self.queryFilters && self.queryFilters.length > 0) {
                schemasManager.search(self.currentPage, self.querySort, self.queryFilters).then(self.postLoad);
            } else {
                schemasManager.getAll(self.currentPage).then(self.postLoad);
            }
        ...
        self.filterConfig = {
            fields: [
                { id: 'schemaName', title:  'Name', placeholder: 'Filter by schema name...', filterType: 'text' },
                { id: 'schemaNameDisplay', title:  'Display Name', placeholder: 'Filter by display name...', filterType: 'text' },
                { id: 'schemaDesc', title:  'Description', placeholder: 'Filter by description...', filterType: 'text' },
        ...
        self.sortConfig = {
            fields: [
                { id: 'schemaName', title:  'Name', sortType: 'alpha' },
                { id: 'schemaNameDisplay', title:  'Display Name', sortType: 'alpha' },
